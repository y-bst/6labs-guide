...
export const SESSIONS: Record<string, Session> = {
  ...
  '2847': { id: '2847', source: 'ai', duration: '4:05', date: '10/11/25', desc: 'Player opened the Guild menu between matches and answered two help requests before queueing.', ai: ['items looted', 'shop opened'], tags: ['Agent run', 'Smoke test'] },
  '2846': { id: '2846', source: 'ai', duration: '4:05', date: '10/11/25', desc: 'A full guild loop in one session: guild page, then Help Requests, cleared one member at a time.', ai: ['menu hesitation', 'fast completion'], tags: ['Agent run', 'Smoke test'] },
